...
def get_bids_at(profile: LinearAdditiveUtilitySpace, utility: float, lower_bound: float = 0.1,
                upper_bound: float = 0.4) -> list:
    """
...
def get_move(my_utility_change: float, opponent_utility_change: float, threshold: float = 0.7) -> str:
    """
